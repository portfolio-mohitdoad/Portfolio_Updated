    ...
    <div>
      ...
      <div className='about'>
        ...
        <div className='content_detail'>
          ...
          <br></br>
          {/* <h1>GRAPHICS DESIGNER.</h1> */}
          <p className = "info">Greetings, my name is Mohit Doad, and I am a highly devoted graphic designer with a solid two years of experience. Throughout my career, I have had the privilege of working in both corporate and freelance environments, honing my skills in graphic design and logo creation.<span className = "additional-info"> One notable accomplishment I take pride in is achieving second place in a national brand identity competition, which speaks to my unwavering dedication to producing high-quality work. In addition to my professional endeavors, I am constantly seeking new creative opportunities to expand my horizons.</span></p>
